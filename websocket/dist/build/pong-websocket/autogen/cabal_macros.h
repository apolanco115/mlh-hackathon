...
/* package pong-websocket-0.1.0.0 */
#ifndef VERSION_pong_websocket
#define VERSION_pong_websocket "0.1.0.0"
#endif /* VERSION_pong_websocket */
#ifndef MIN_VERSION_pong_websocket
#define MIN_VERSION_pong_websocket(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pong_websocket */
...
#define CURRENT_COMPONENT_ID "pong-websocket-0.1.0.0-3JiEulLWDPWCxbcQLMxF9l-pong-websocket"
